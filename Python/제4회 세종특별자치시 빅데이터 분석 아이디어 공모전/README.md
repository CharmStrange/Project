...
> 
>  ### **My Idea** : [ 지역별로 침수 위험 정도에 따라 수위 측정 기준면을 설정하여, 측정 센서를 통해 침수 피해를 최소화할 수 있도록, 침수 가능성이 높은 지역에 대해 해당 지역의 주민, 상인, 근무자 등의 사람들이 미리 알 수 있도록 예보 또는 경보를 해 주는 시스템을 구축하기 ]
> 
> [아이디어를 구현한 코드](project_pseudocode.c)
