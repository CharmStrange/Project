...
> ```
> 위와 같은 경우 각 내용물의 개수가 10, 28, 15, 25 이며 `First_Pack` 객체는 한 번의 재고 보충을 의미한다고 이해할 수 있다. `batch size`를 어떻게 정의하느냐에 따라, 재고 보충과 수익 계산을 다르게 할 수 있다. 클래스의 메소드를 통해 부수적인 계산도 할 수 있다.
