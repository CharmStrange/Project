...
ele_0 = np.random.normal(vec_0_mean, vec_0_std, 100)
eles_0 = [round(round_ele_0) for round_ele_0 in ele_0]

ele_1 = np.random.normal(vec_1_mean, vec_1_std, 100)
eles_1 = [round(round_ele_1) for round_ele_1 in ele_1]

ele_2 = np.random.normal(vec_2_mean, vec_2_std, 100)
eles_2 = [round(round_ele_2) for round_ele_2 in ele_2]

ele_3 = np.random.normal(vec_3_mean, vec_3_std, 100)
eles_3 = [round(round_ele_3) for round_ele_3 in ele_3]

ele_4 = np.random.normal(vec_4_mean, vec_4_std, 100)
eles_4 = [round(round_ele_4) for round_ele_4 in ele_4]

ele_5 = np.random.normal(vec_5_mean, vec_5_std, 100)
eles_5 = [round(round_ele_5) for round_ele_5 in ele_5]

ele_6 = np.random.normal(vec_6_mean, vec_6_std, 100)
